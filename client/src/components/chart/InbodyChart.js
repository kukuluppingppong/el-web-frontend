...
import {
    ...
    MY_PAGE_REQUEST
} from '../../redux/features/myPage/myPageSlice';
    ...
    return (
        <div>
            <h3>체중 기록</h3>
            {
                ...
                <>
                    <p>지난 체중 통계를 확인하기위해서는<br />체중을 등록해주세요.</p>
                </>
            }
            {
                weightHistoryList.length !== 0 &&
                    ...
                    <div>
                        ...
                        >
                            <div>
                                ...
                                <hr />
                                <div>
                                    <button onClick={RegisterhandleClose}>
                                        닫기
                                    </button>
                                    <button onClick={handleWeightHistoryRegisterConfirm}>
                                        등록
                                    </button>
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div>
                                    ...
                                    <button onClick={handleWeightHistoryUpdateConfirm}>
                                        수정
                                    </button>
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div>
                                    ...
                                    <button onClick={handleWeightHistoryDeleteConfirm}>
                                        삭제
                                    </button>
                                </div>
                            </div>
